<!DOCTYPE html>
<?php echo $__env->make('include.kalender', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<html lang="en">
  <head>
    <meta charset="utf-8">
    ...
    <link href="<?php echo e(asset('assets/css/animate-custom.css')); ?>" rel="stylesheet">
	...
	<script type="text/javascript" src="<?php echo e(asset ('assets/js/modernizr.custom.js')); ?>"></script>
  ...
  <body data-spy="scroll" data-offset="0" data-target="#navbar-main">
	...
	<br>
		...
		<?php echo $__env->make('include.content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	...
	<script type="text/javascript" src="<?php echo e(asset ('assets/js/retina.js')); ?>"></script>
	...
	<script type="text/javascript" src="<?php echo e(asset ('assets/js/jquery-func.js')); ?>"></script>
  </body>
</html>
<?php /**PATH C:\laragon\www\berita-ml\resources\views/index.blade.php ENDPATH**/ ?>